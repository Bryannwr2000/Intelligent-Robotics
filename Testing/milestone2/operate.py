...
class Operate:
        ...
        for event in pygame.event.get():
           ...
           # drive forward
            ...
            # save robot position
                ...
                self.command['save_robot_pose'] = True
            # save image
    ...
    #Save robot final position
    def save_robot_pose(self, fname="robot_pose.txt"):
            """
            Save robot position in to robot_pose.txt
            """
            if self.command['save_robot_pose'] == True:
                map_attributes = {"robot_x":self.ekf.robot.state[0][0],
                ...
                self.command['save_robot_pose'] = False
...
if __name__ == "__main__":
    ...
    while start:
        ...
        operate.update_slam(drive_meas) #update robot pos to slam
        operate.record_data()
        operate.save_image()

        #save last robot position after saving SLAM
        operate.save_robot_pose()
