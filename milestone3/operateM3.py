...
class Operate:
    ...
    def plot_map(self):
        ...
        ax = plt.gca()
        ax.scatter(us_vec[0,:10], us_vec[1,:10], marker='x', color='C1', s=100)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--map", type=str, default='marker_pose_transformed.txt')
